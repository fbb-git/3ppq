...
class Tools
{
    ...
    public:
        ...
        static char const *message(int enumValue);
        ...
        static std::string link(uint16_t psychID, 
                                std::string const &clientIdent,  
                                uint16_t loginValue);
...
inline char const *Tools::message(int enumValue)
{
    return s_messages[enumValue];
}
